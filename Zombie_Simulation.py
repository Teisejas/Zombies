...
henergy = np.random.randint(150,200) # human lives between 150 and 200 steps
...
for n in range(int(nhumans/2)):
    everyone.append(individual(np.random.randint(32,50),np.random.randint(32,50),
                               0,boundx,boundy, henergy, human, hspeed))

#initiate human Population B
for n in range(int(nhumans/2)):
    everyone.append(individual(np.random.randint(10,32),np.random.randint(10,32),
                               0,boundx,boundy, henergy, human, hspeed))
...
f = r"c://Users/xxxx/animation.gif" 
